...
export class CustomerAndAddress1645811072717 implements MigrationInterface {
    name = 'CustomerAndAddress1645811072717'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customer" ADD CONSTRAINT "FK_e778874fe6fc10e02b83618f78f" FOREIGN KEY ("correspondenceAddressId") REFERENCES "address"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
